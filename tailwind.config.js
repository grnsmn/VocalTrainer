		...
		extend: {
			...
			colors: {
				...
				backgroundLightError:
					'rgb(var(--color-backgroundLightError)/<alpha-value>)',
				backgroundDarkError:
					'rgb(var(--color-backgroundDarkError)/<alpha-value>)',
				backgroundLightWarning:
					'rgb(var(--color-backgroundLightWarning)/<alpha-value>)',
				backgroundDarkWarning:
					'rgb(var(--color-backgroundDarkWarning)/<alpha-value>)',
				backgroundLightSuccess:
					'rgb(var(--color-backgroundLightSuccess)/<alpha-value>)',
				backgroundDarkSuccess:
					'rgb(var(--color-backgroundDarkSuccess)/<alpha-value>)',
				backgroundLightInfo:
					'rgb(var(--color-backgroundLightInfo)/<alpha-value>)',
				backgroundDarkInfo:
					'rgb(var(--color-backgroundDarkInfo)/<alpha-value>)',
				backgroundLightMuted:
					'rgb(var(--color-backgroundLightMuted)/<alpha-value>)',
				backgroundDarkMuted:
					'rgb(var(--color-backgroundDarkMuted)/<alpha-value>)',
